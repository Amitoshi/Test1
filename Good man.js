...
function getData() {
    // console.log("No");
    // document.write("<h2>He is Good man now :)</h2>");
    ...
    // console.log(value);
    var searchCityList = city.filter(e => (e.name).toLowerCase().includes(value.toLowerCase()));
    var html="";
    for (let i = 0; i < searchCityList.length; i++) {
        // console.log(searchCityList[i]);
        html= html + '<p>' + searchCityList[i].id +'</p>' + '<p>' + searchCityList[i].name +'</p>' + '<p>' + searchCityList[i].state +'</p><br>' 
    }
    document.getElementById('Cityid').innerHTML = html;
    // document.getElementById('City').innerHTML = searchCityList[i].name;
    // document.getElementById('state').innerHTML = searchCityList[i].state;
